    ...
    <div className="w-full px-4 py-20 bg-black">
      <div className="max-w-[1250px] mx-auto grid grid-cols-4">
        ...
        <div className="flex flex-col mx-auto w-[30%]">
          <p className="font-poppins text-gigapink text-lg">Links</p>
          <Link href="/">
            <a className="">
              <div className="flex flex-row gap-2 group">
                <p className="font-poppins text-white text-md uppercase group-hover:text-gigapink">
                  Portfolio
                </p>
                <div className="flex flex-col justify-center">
                  <svg
        ...
        <div className="flex flex-col mx-auto w-[30%]">
          <p className="font-poppins text-gigablue text-lg">Connect</p>
          <Link href="/">
            <a className="">
              <div className="flex flex-row gap-2 group">
                <p className="font-poppins text-white text-md uppercase group-hover:text-gigablue">
                  Facebook
                </p>
                <div className="flex flex-col justify-center">
                  <svg
        ...
        <div className="flex flex-col ml-auto">
          <p className="font-poppins text-gigapink text-lg">Our HQ</p>
          <p className="font-poppins text-white text-md uppercase">
            Estate House <br />
            (2nd Floor)
          </p>
          <p className="font-poppins text-white text-md uppercase">Preston</p>
          <p className="font-poppins text-white text-md uppercase">PR1 2AB</p>
        </div>
      </div>
